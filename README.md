...
<p>As a Full Stack Software Engineer, I bring to bear 9 years of professional experience, during which I've developed and published numerous web and mobile applications leveraging modern JavaScript Frameworks and Libraries including but not limited to React(Primary), Vue, Next, and Nuxt for the front end. I've also utilized back-end technologies such as Node.js/Express.js(Primary), Python/Django, PHP/Laravel, and Java.</p>
...
<p>Furthermore, I have built upon this foundation with significant DevOps experience. I am proficient in a variety of cloud platforms such as AWS, Azure, and GCP, using them to ensure seamless deployment and management of applications. This comprehensive skill set makes me adept at managing the complete development life cycle of a project.</p>
